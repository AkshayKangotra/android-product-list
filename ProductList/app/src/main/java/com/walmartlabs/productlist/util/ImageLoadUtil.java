...
public class ImageLoadUtil {
    ...
    public static void loadImage(final Context context, final ImageView imageView, final String url, final IonBitmapCache ionBitmapCache) {
                    ...
                    public void onCompleted(Exception e, Bitmap result) {
                        if (result != null) {
                            BitmapInfo info = new BitmapInfo(AndroidUtil.sha256String(url),
                                    context.getString(R.string.ion_cache_image_type), new Bitmap[]{result}, null);
